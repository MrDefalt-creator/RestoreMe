...
namespace Backup.Server.Infrastructure.Migrations
{
    ...
    [Migration("20260712170431_RefreshTokenHardening")]
    partial class RefreshTokenHardening
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Backup.Server.Domain.Entities.IntegrityScrubSettings", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.Property<int>("RunAtMinutesUtc")
                        .HasColumnType("integer");

                    b.HasKey("Id");

                    b.ToTable("IntegrityScrubSettings");
                });
            ...
            modelBuilder.Entity("Backup.Server.Domain.Entities.RefreshToken", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("Backup.Server.Domain.Entities.RefreshToken", b =>
                {
                    b.HasOne("Backup.Server.Domain.Entities.AppUser", "User")
                        .WithMany()
