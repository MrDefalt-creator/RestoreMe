...
const dictionaries: Record<Language, Record<string, string>> = {
  ...
  ru: {
    ...
    'Re-hash the stored object and compare to its recorded checksum':
      'Перечитать объект из хранилища и сверить SHA256 с сохранённым',
    'Integrity scrub schedule': 'Расписание проверки целостности',
    'Periodically re-hash stored backups to detect silent corruption.':
      'Периодически перехэшировать хранимые копии для обнаружения тихого повреждения.',
    ...
    'Devices with an active session on your account. Sign out any you don’t recognise.':
      'Устройства с активной сессией в вашем аккаунте. Завершите те, что не узнаёте.',
    ...
    'Unable to sign out session': 'Не удалось завершить сессию',
    'Signed out everywhere': 'Выполнен выход на всех устройствах',
    'Unable to sign out': 'Не удалось выйти',
    'End sessions': 'Завершить сессии',
    'End all sessions?': 'Завершить все сессии?',
    'This signs {username} out of every device. They keep their password and can sign in again.':
      'Пользователь {username} будет разлогинен на всех устройствах. Пароль сохранится, вход снова возможен.',
    'Sessions ended': 'Сессии завершены',
    'Unable to end sessions': 'Не удалось завершить сессии',
    Disabled: 'Отключен',
    ...
    Weekly: 'Еженедельно',
    Monthly: 'Ежемесячно',
    'Custom cron': 'Произвольное выражение cron',
    'Run at': 'Время запуска',
    ...
    'Window start and end are required': 'Укажите начало и конец окна',
    'Window start and end must differ': 'Начало и конец окна должны отличаться',
    ...
    'Search this page by job, policy, agent, or error...': 'Поиск на этой странице: задание, политика, агент, ошибка...',
    Sort: 'Сортировка',
    ...
    'By name': 'По имени',
    'No matches on this page — flip pages or clear the search.':
      'На этой странице совпадений нет — листайте страницы или очистите поиск.',
    'No matches on this page — flip pages or clear the filters.':
      'На этой странице совпадений нет — листайте страницы или сбросьте фильтры.',
    pending: 'ожидает',
    running: 'выполняется',
    failed: 'ошибка',
    completed: 'завершено',
