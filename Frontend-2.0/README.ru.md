...
- страница политик: создание, редактирование, тоггл, плюс бейдж «Auto-disabled» и повторное включение в один клик для политик, остановленных после серии провалов; в форме политики есть настройки ретенции (хранение по возрасту / количеству / суммарному размеру)
