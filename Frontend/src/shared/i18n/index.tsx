...
const dictionaries: Record<Language, Record<string, string>> = {
  ...
  ru: {
    ...
    'Artifact download started': 'Скачивание артефакта началось',
    ...
    'The requested route is not available in the current RestoreMe console. Use the navigation menu or return to the main dashboard.': 'Запрошенный маршрут недоступен в текущей консоли RestoreMe. Используйте меню навигации или вернитесь на главную панель.',
    'Application error': 'Ошибка приложения',
    'Unable to open the requested page': 'Не удалось открыть страницу',
    'The route could not be rendered correctly. Try returning to the dashboard or reloading the page.': 'Маршрут не удалось отобразить корректно. Вернитесь на панель или обновите страницу.',
    Host: 'Хост',
    Identity: 'Профиль',
    ...
    'Days must be zero or greater': 'Дни должны быть не меньше 0',
    'Hours must be zero or greater': 'Часы должны быть не меньше 0',
    'Hours must be between 0 and 23': 'Часы должны быть от 0 до 23',
    'Minutes must be zero or greater': 'Минуты должны быть не меньше 0',
    'Minutes must be between 0 and 59': 'Минуты должны быть от 0 до 59',
    'Seconds must be zero or greater': 'Секунды должны быть не меньше 0',
    'Seconds must be between 0 and 59': 'Секунды должны быть от 0 до 59',
    'Port must be zero or greater': 'Порт должен быть не меньше 0',
    'Interval must be at least 60 seconds': 'Интервал должен быть не меньше 60 секунд',
